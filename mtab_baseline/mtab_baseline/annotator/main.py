...
from api import m_f
from api.annotator import m_input, m_preprocess

# >>> MODIFIED START
# use our modified version of m_structure and m_semantic
from mtab_baseline.annotator import m_structure, m_semantic
...
def run(
    ...
    def call_annotation():
        ...
        # >>> MODIFIED START
        # pass down the table headers so that m_structure do not need to predict it
        if table_headers is not None:
            table_obj["headers"] = table_headers
